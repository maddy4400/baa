            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="bg-white main-title height-80 d-flex flex-row justify-content-between align-items-center">
                        <h1>Manage Jobs</h1>
                        <a href="post-a-job.html" class="btn btn-header">Post a Job</a>
                    </div>
                    ...
                    <div class="directory-card">
                        <div class="row d-flex align-items-center">
                            <div class="col-md-9">   
                                ...
                                <a href="view-company-detail.html"><p class="mb-0 font-13">Company Name</p></a>                                   
                            </div>
                            <div class="col-md-3 text-left text-md-right">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                      ...
                                      <a class="dropdown-item" href="view-job-detail.html">View Job Details</a>
                        ...
                        <hr/>
                        <div class="row">
                            <div class="col-md-3 mb-2 mb-md-0"><span>Product Category</span><br><strong>Handicraft</strong></div>
                            <div class="col-md-3 mb-2 mb-md-0"><span>Experience</span><br><strong>1 - 2 Years</strong></div>
                            <div class="col-md-3 mb-2 mb-md-0"><span>Salary</span><br><strong>Rs. 8,00,000 p.a</strong></div>
                            <div class="col-md-3"><span>Location</span><br><strong>Ahmedabad</strong></div>
                        </div>
                    </div>
                    ...
                    <div class="directory-card">
                        <div class="row d-flex align-items-center">
                            <div class="col-md-9">   
                                <p class="font-12">Posted 1 Day Ago&nbsp;&nbsp;|&nbsp;&nbsp;Active</p>                             
                                <h5 class="job-title">Product Develop Manager</h5>
                                <p class="mb-0 font-13">Company Name</p>                                   
                            </div>
                            <div class="col-md-3 text-left text-md-right">
                                <div class="btn-group">
                                    <button type="button" 
                    ...
                    <div class="directory-card">
                        <div class="row d-flex align-items-center">
                            <div class="col-md-9">   
                                <p class="font-12">Posted 1 Day Ago&nbsp;&nbsp;|&nbsp;&nbsp;Active</p>                             
                                <h5 class="job-title">Logistics Managers</h5>
                                <p class="mb-0 font-13">Company Name</p>                                   
                            </div>
                            <div class="col-md-3 text-left text-md-right">
                                <div class="btn-group">
