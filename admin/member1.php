                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <ul class="form-progress">
                            <li class="active" onclick="location.href='member1.html'"></li>
                            <li onclick="location.href='member2.html'"></li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 offset-md-3 text-center mt-4 px-1 px-md-5">
                                        <a type="submit" class="btn btn-block btn-primary btn-raised btn-rounded" onclick="location.href='member2.html'">Next</a>
                                    </div> 
                                </div>
                            </div>                        
                        </form>                                                
