            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="directory-card">
                            ...
                            <div class="col-md-3 text-left text-md-right">
                                <div class="btn-group m-0">
                                    ...
                                    <div class="dropdown-menu">
                                      ...
                                      <a class="dropdown-item" href="#">Renew Membership</a>
                                      <a class="dropdown-item" href="#">Approve</a>
                                      <a class="dropdown-item" href="#">Reject & Delete</a>
                                    </div>
                                </div>
                            </div> 
                        </div>
                        <hr/>
                        <div class="row">
                            <div class="col-md-6 mb-3 mb-md-0"><span>Product Category</span><br><strong class="font-16">Handicraft</strong></div>
                    ...
                    <div class="detail-card">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6"><span>CEO Name:</span><br><strong>John Doe</strong></div>
                            <div class="col-md-6"><span>CEO Mobile No:</span><br><strong>+919099454510</strong></div>
                        </div>  
                        <div class="row">
                            <div class="col-md-6"><span>Contact Person:</span><br><strong>Peter Ross</strong></div>
                            <div class="col-md-6"><span>Contact person Mobile No:</span><br><strong>+919099212110</strong></div>                           
                        </div>                       
                    </div>
                    ...
                    <div class="detail-card pb-0">
                        ...
                        <div class="row mb-3 document-list">
                            <div class="col-md-4"><img src="../images/orange-true.svg" /><a href="#" class="ml-2 text-underline">CA Certificate.pdf</a></div>
                            <div class="col-md-4"><img src="../images/orange-true.svg" /><a href="#" class="ml-2 text-underline">Code of conduct.pdf</a></div>
                            <div class="col-md-4"><img src="../images/orange-true.svg" /><a href="#" class="ml-2 text-underline">PAN Card.jpg</a></div>
                            <div class="col-md-4"><img src="../images/orange-true.svg" /><a href="#" class="ml-2 text-underline">GSTIN copy.jpg</a></div>
                            <div class="col-md-4"><img src="../images/orange-true.svg" /><a href="#" class="ml-2 text-underline">IEC Copy.pdf</a></div>
                        </div>                                               
                    </div>
                </div>
            </div>
