        ...
        <section class="w-100">
            <div class="container"> 
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <ul class="form-progress">
                            ...
                            <li class="active" onclick="location.href='member2.html'"></li>
                            <li onclick="location.href='member3.html'"></li>
                        ...
                        <form class="" novalidate>
                           <div class="col-md-10 offset-md-1 text-center px-1 px-md-5">                        
                            ...
                            <div class="form-section">
                                <h4 class="form-section-title">Download Documents</h4>
                                <div class="row">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        <p>1. CA Certificate * <a href="#" class="text-orange text-hover-black text-underline">Download Form</a></p>
                                    ...
                                    <div class="col-md-6">
                                        <p>2. Code Of Conduct * <a href="#" class="text-orange text-hover-black text-underline">Download Form</a></p>
                                        <div class="form-group bg-group">                                    
                            ...
                            <div class="multisteps-form__content">
                                <div class="row">
                                    <div class="col-md-6 offset-md-3 text-center mt-4 px-1 px-md-5">
                                        <a class="btn btn-block btn-primary btn-raised btn-rounded" onclick="location.href='member3.html'">Next</a>
                                    </div> 
                                </div>
                            </div> 
                        </form>                                                
                ...
                <div class="text-center mt-3">
                    <a href="#" class="text-dark-light" onclick="location.href='member3.html'">Do it Later</a>            
                </div>            
            </div>
        </section>
    </main>
