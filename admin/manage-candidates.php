        ...
        <div class="container">
            <div class="row">
                    ...
                    <aside class="panel-sticky" id="panel-sticky">
                        ...
                        <div class="bg-white">
                            ...
                            <div class="list-group nav-list">
                                ...
                                <a href="manage-candidates.html" class="list-group-item list-group-item-action active">Manage Candidates</a>
                ...
                <div class="col-md-9">
                    ...
                    <div class="manageresume-card">
                        <div class="row d-flex align-items-center">
                            <div class="col-md-9">                              
                                <h3 class="mt-0">Alex Morgan</h3>
                                <h4 class="mb-0">Product Development Manager</h4>
                            </div>
                            <div class="col-md-3 text-left text-md-right align-items-center">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">View Resume</a>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4 mb-2 mb-md-0"><span>Product Category:</span><br><strong>Home Textile</strong></div>
                                    <div class="col-md-4 mb-2 mb-md-0"><span>Experience:</span><br><strong>1 - 2 Years</strong></div>
                                    <div class="col-md-4 mb-2 mb-md-0"><span>Location:</span><br><strong>Ahmedabad</strong></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
