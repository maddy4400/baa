        ...
        <section class="w-100">
            <div class="container"> 
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <ul class="form-progress">
                            ...
                            <li class="filled" onclick="location.href='organization3.html'"></li>
                            <li class="active" onclick="location.href='organization4.html'"></li>
                        </ul>
                    </div>
                </div>     
                <!--progress bar-->          
                ...
                <div class="text-center mt-3">
                    <a href="#" class="text-dark-light" onclick="location.href='user/newsfeed.html'">Skip</a>            
                </div>            
            </div>
        </section>
    </main>
