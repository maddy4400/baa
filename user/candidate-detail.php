    ...
    <main class="main">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="bg-white main-title">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <a href="hirecandidate.html"><img src="../images/back.svg" alt="back"/></a>
                            </div>                        
                        </div>
                        <div class="row">
                            <div class="col-md-10">
                                <h1 class="mb-2">Product Development Manager</h1>
                                <p class="mb-0 font-12">Posted 1 Day Ago | Active</p>
                            </div>
                            <div class="col-md-2">
                                <div class="btn-group">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2 mb-md-0"><span>Product Category:</span><br><strong>Home Textiles</strong></div>
                            <div class="col-md-4 mb-2 mb-md-0"><span>Experience:</span><br><strong>1 - 2 Years</strong></div>
                            <div class="col-md-4 mb-2 mb-md-0"><span>Location:</span><br><strong>Ahmedabad</strong></div>
                        </div>                                            
                    </div>

                    <div class="hireagent-card mt-4">
                        <h2 class="card-title-2">All Applicants list</h2>
                    </div>
                    
                    <div class="hireagent-card">
                        <div class="row d-flex align-items-center">
                            <div class="col-md-8 col-lg-9">                              
                                <h3 class="mt-0">Alex Morgan</h3>
                                <h4 class="mb-0">Product Development Manager</h4>
                            </div>
                            <div class="col-md-4 col-lg-3 text-left text-md-right align-items-center mt-2 mt-md-0">
                                <a href="resume.pdf" class="btn btn-raised btn-primary btn-square" download>Download Resume</a>
                            </div>
                            <div class="col-md-12">
                                <hr/>
                            </div>
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4 mb-2 mb-md-0"><span>Experience:</span><br><strong>5 Years 2 Months</strong></div>
                                    <div class="col-md-4 mb-2 mb-md-0"><span>Current Salary:</span><br><strong>Rs. 5,00,000 p.a</strong></div>
                                    <div class="col-md-4 mb-2 mb-md-0"><span>Current Location:</span><br><strong>Ahmedabad</strong><br><span>Ready to Relocate</span></div>
                                </div>
                            </div>
                        </div>
                    </div> 
