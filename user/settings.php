                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-10 col-md-6">
                                        <h6 class="username-display">Johndoe64</h6>
                                    </div>
                                ...
                                <div class="row username-input d-none">
                                    <div class="col-12">                                        
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="form-group col-md-5 px-0 pt-0">
                                                <input type="text" class="control w-100"  placeholder="Johndoe64">
                    ...
                    <div class="setting-card">
                        ...
                        <div class="row setting-detail">
                            <div class="col-9 col-md-6">                               
                                <h6>Membership Notifications</h6>
                            </div>
