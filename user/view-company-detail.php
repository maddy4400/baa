            ...
            <div class="row">
                    ...
                    <aside class="panel-sticky" id="panel-sticky">
                        ...
                        <div class="bg-white">
                            <div class="intro text-center">
                                <a href="#" target="_blank"><img src="../images/ph-logo.svg"
                            ...
                            <div class="list-group nav-list">
                                ...
                                <a href="directory.html"
                                    class="list-group-item list-group-item-action active">Directory</a>
                                <a href="hirecandidate.html" class="list-group-item list-group-item-action">Hire
                                    Candidate </a>
                                <a href="my-profile.html" class="list-group-item list-group-item-action">My Profile</a>
                                <a href="settings.html" class="list-group-item list-group-item-action">Account
                                    Settings</a>
                            </div>
                        </div>
                        <div class="bg-white mt-20 social">
                            ...
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><a href="#" target="_blank"><img
                                            src="../images/facebook.svg" /></a></li>
                                <li class="list-inline-item"><a href="#" target="_blank"><img
                                            src="../images/twitter.svg" /></a></li>
                                <li class="list-inline-item"><a href="#" target="_blank"><img
                                            src="../images/linkedin.svg" /></a></li>
                                <li class="list-inline-item"><a href="#" target="_blank"><img
                                            src="../images/instagram.svg" /></a></li>
                            </ul>
                        </div>
                ...
                <div class="col-md-9">
                    <div class="bg-white main-title height-80 d-flex align-items-center">
                        <a href="directory.html"><img src="../images/back.svg" alt="back" class="mr-3" /></a>
                    ...
                    <div class="directory-card">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-md-2 text-right">
                                <a href="#exampleModal" class="btn btn-primary btn-raised btn-square" data-toggle="modal">Contact</a>
                            </div>
                        </div>
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        <span>Website:</span><br><strong>www.octetdesigns.com</strong></div>
                                    <div class="col-md-6"><span>Registered Address:</span><br><strong>915, North Plaza
                                            Motera,
                    ...
                    <div class="detail-card">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <h4 class="title mb-4">Product Catalogue</h4>
                                <div class="row parent-container">                                    
                                    <div class="col-md-4 mb-4 catalogue-box">
                                        <a href="../images/product/1.png">
