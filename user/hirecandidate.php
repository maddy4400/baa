    ...
    <main class="main">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="bg-white main-title height-80 d-flex align-items-center justify-content-between">
                        <h1>Your Job Posts</h1>
                        <a href="post-a-job.html" class="btn btn-job">Post a Job</a>
                    </div>
                    ...
                    <div class="hireagent-card">
                        <div class="row">
                                ...
                                <div class="row d-flex align-items-center">
                                    <div class="col-md-8 col-lg-9">                              
                                        <a href="candidate-detail.html">
                                            <h3 class="mt-0">Product Development Manager</h3>
                                        </a>
                            ...
                            <div class="col-md-3 text-right">
                                <p class="font-12 mb-2">25 Applications</p>
                                <a href="candidate-detail.html" class="btn btn-primary btn-raised btn-square">View Applicants</a>
                                <div class="btn-group">
